...
CREATE TABLE ODE_SCOPE -- ScopeDAOImpl
    (SCOPE_ID BIGINT NOT NULL, MODEL_ID INTEGER, SCOPE_NAME VARCHAR(255), SCOPE_STATE VARCHAR(255), PARENT_SCOPE_ID BIGINT, PROCESS_INSTANCE_ID BIGINT, PRIMARY KEY (SCOPE_ID));
...
CREATE TABLE STORE_PROCESS_PROP -- ProcessConfPropertyDaoImpl
    ...
    PROP_KEY VARCHAR(255), DATA CLOB, PRIMARY KEY (id));
