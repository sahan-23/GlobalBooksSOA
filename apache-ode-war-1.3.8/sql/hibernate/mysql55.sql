...
create table ODE_SCHEMA_VERSION(VERSION integer) ENGINE=INNODB;
...
CREATE TABLE ODE_JOB (
  ...
  INDEX IDX_ODE_JOB_NODEID(nodeid)
    ...
    create table BPEL_MESSAGE (
        ...
        MEX bigint,
        TYPE varchar(255),
        MESSAGE_DATA longblob,
        MESSAGE_HEADER longblob,
        INSERT_TIME datetime,
        MLOCK integer not null,
        primary key (ID)
    ) ENGINE=INNODB;
    ...
    create table BPEL_PLINK_VAL (
        ...
        MYROLE_EPR_DATA longblob,
        PARTNERROLE_EPR_DATA longblob,
        PROCESS bigint,
        SCOPE bigint,
        SVCNAME varchar(255),
        MYROLE varchar(100),
